...
class motorTestSuite(TestSuite):
   ...
   def createTests(self):
      ...
      Target("pmac", self, [
            BuildEntity('tpmac'),
            IocEntity('ioc', directory='iocs/pmacGeobrickExample', bootCmd='bin/linux-x86/stpmacTest.boot'),
            EpicsDbEntity('db', directory='iocs/pmacGeobrickExample', fileName="db/pmacTest.db")])
