...
#### ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ...
  dbLoadTemplate ("dbLoad/cs.TsubSpeed",     pmac_cs)
...
#### ^^^^^^^^^^^^^^^^^^^^^^^^^
  ...
  dbLoadTemplate ("dbLoad/hs.TsubSpeed",     pmac_hs)
...
#### ^^^^^^^^^^^^^^^^^
  ...
  dbLoadTemplate ("dbLoad/md.TsubSpeed",     pmac_md)
...
#### ^^^^^^^^^^^^^^^^
  ...
  dbLoadTemplate ("dbLoad/mi.TsubSpeed",     pmac_mi)
...
#### ^^^^^^^^^^^^^^
  ...
  dbLoadTemplate ("dbLoad/mo.TsubSpeed",     pmac_mo)
...
#### ^^^^^^^^^^^^^^^
  ...
  dbLoadTemplate ("dbLoad/tb.TsubSpeed",     pmac_tb)
...
#### ^^^^^^^^^^^^^^^^^^^^^^^^
  ...
  dbLoadTemplate ("dbLoad/xy.TsubSpeed",     pmac_xy)
