...
# putenv ("EPICS_CA_ADDR_LIST=164.54.210.2 164.54.210.140 164.54.210.154 164.54.210.155 164.54.210.180")
  putenv ("EPICS_CA_ADDR_LIST=164.54.210.2 164.54.210.180 164.54.210.138")
...
### for that.)
  dbLoadRecords("$(SSCAN)/scan.db","P=23o:2:,MAXPTS1=2000,MAXPTS2=20,MAXPTS3=1,MAXPTS4=1,MAXPTSH=2000")
...
# devScaler_VSDebug=5
# scalerRecordDebug=0
  dbLoadRecords("$(STD)/scaler32.db","P=23o:,S=scaler3,C=0, DTYP=Joerger VS, FREQ=10000000, OUT=#C0 S0 @")
...
### Robot databases:
  dbLoadRecords("$(GMCA)/robot.db","bln=23o:")
#^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
### Disable BeamStop-Out if fast shuter is open:
    dbpf ("23o:BS:PT:RqsPosRcl2.SDIS","23o:SH:mp:bo:rbk PP MS")
